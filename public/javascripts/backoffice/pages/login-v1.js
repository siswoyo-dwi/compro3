$(function() {
    if($('body').data('page') == 'login'){
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["/stylesheets/backoffice/images/gallery/login4.jpg", "/stylesheets/backoffice/images/gallery/login3.jpg", "/stylesheets/backoffice/images/gallery/login2.jpg", "/stylesheets/backoffice/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
