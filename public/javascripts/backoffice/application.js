...
function switchLanguage() {
    ...
    $('#language-header').on('click', 'ul a', function(e) {
        ...
        if($('body').hasClass('builder-admin') || $('.page-content').hasClass('page-builder') || $('.page-content').hasClass('email-builder') || $('.page-content').hasClass('frontend-builder')) {
            $("[data-translate]").jqTranslate('plugins/translate/application', {
                forceLang: language
            });
        }
        else{
...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        $.backstretch(["stylesheets/backoffice/images/gallery/bg1.jpg", "stylesheets/backoffice/images/gallery/bg2.jpg", "stylesheets/backoffice/images/gallery/bg3.jpg", "stylesheets/backoffice/images/gallery/bg4.jpg"], {
            fade: 3000,
            duration: 4000
        });
    }
